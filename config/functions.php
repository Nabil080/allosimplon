...
function ShowAddFav($ID_film,$likes){
    if(require("connexion.php")){
    ?><form method="post" action="/portfolio/allosimplon/traitements/add/add_user_fav.php" class="w-fit">
...
function ShowDeleteFav($ID_film,$likes){
    if(require("connexion.php")){
    ?><form method="post" action="/portfolio/allosimplon/traitements/delete/delete_user_fav.php" class="w-fit">
    <input class="hidden" name="ID_user" value="<?=$_SESSION['ID_user']?>">
    <input class="hidden" name="ID_film" value="<?=$ID_film?>">
    <button type="submit" name="submit" value="submit" class="group/fav z-20 w-fit">
...
if(isset($_SESSION['ID_user'])){
    ...
    ?>
        <div class="grade text-main-light text-2xl text-center">
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=2&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=4&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=6&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=8&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=10&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    <?php }
    if($note >=2 && $note < 4){
    ?>
        <div class="grade text-main-light text-2xl text-center">
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=2&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=4&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=6&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=8&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=10&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
    ...
    if($note >=4 && $note < 6){
        ...
        <div class="grade text-main-light text-2xl text-center">
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=2&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=4&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=6&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=8&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=10&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    ...
    if($note >= 6 && $note < 8){
        ...
        <div class="grade text-main-light text-2xl text-center">
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=2&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=4&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=6&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=8&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=10&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    <?php }
    if($note >=8 && $note <= 9 ){
        ...
        <div class="grade text-main-light text-2xl text-center">
            ...
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=4&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=6&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=8&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=10&film=<?=$ID_film?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    <?php }
    if($note > 9 && $note <= 10){
        ...
        <div class="grade text-main-light text-2xl text-center">
            ...
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=6&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=8&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/portfolio/allosimplon/traitements/add/add_note.php?note=10&film=<?=$ID_film?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
        </div>
    <?php }
}else{
    if($note >=0 && $note < 2){
