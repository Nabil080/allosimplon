...
{
    if (require ('connexion.php')) {
        ?><form method="post" action="/traitements/add/add_user_fav.php" class="w-fit">
...
{
    if (require ('connexion.php')) {
    ?><form method="post" action="/traitements/delete/delete_user_fav.php" class="w-fit">
    <input class="hidden" name="ID_user" value="<?= $_SESSION['ID_user'] ?>">
    <input class="hidden" name="ID_film" value="<?= $ID_film ?>">
    <button type="submit" name="submit" value="submit" class="group/fav z-20 w-fit">
...
function IsFilmFav($ID_film, $ID_user, $likes)
{
    if (require ('connexion.php')) {
        ...
        if ($fav) {
            ShowDeleteFav($ID_film, $likes);
        } else {
            ShowAddFav($ID_film, $likes);
        }
    }
}
...
function Stars($note, $ID_film)
{
    if (isset($_SESSION['ID_user'])) {
        ...
        <div class="grade text-main-light text-2xl text-center">
            <a href="/traitements/add/add_note.php?note=2&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=4&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=6&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=8&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=10&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    <?php
        }
        if ($note >= 2 && $note < 4) {
    ?>
        <div class="grade text-main-light text-2xl text-center">
            <a href="/traitements/add/add_note.php?note=2&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=4&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=6&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=8&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=10&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
    ...
    ?>
        <div class="grade text-main-light text-2xl text-center">
            <a href="/traitements/add/add_note.php?note=2&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=4&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=6&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=8&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=10&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    ...
    ?>
        <div class="grade text-main-light text-2xl text-center">
            <a href="/traitements/add/add_note.php?note=2&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=4&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=6&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=8&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=10&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    <?php
    ...
    ?>
        <div class="grade text-main-light text-2xl text-center">
            ...
            <a href="/traitements/add/add_note.php?note=4&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=6&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=8&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=10&film=<?= $ID_film ?>"><i class="fa-regular fa-star cursor-pointer"></i></a>
        </div>
    <?php
        }
    ...
    ?>
        <div class="grade text-main-light text-2xl text-center">
            ...
            <a href="/traitements/add/add_note.php?note=6&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=8&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
            <a href="/traitements/add/add_note.php?note=10&film=<?= $ID_film ?>"><i class="fa-solid fa-star cursor-pointer"></i></a>
        </div>
    <?php
        }
    } else {
