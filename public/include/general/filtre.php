...
<div id="filtres" class="mt-2 grow w-full md:max-w-[230px] hidden md:block">
    <?php if(!empty($filters)){?><form method="post" action="/traitements/delete/delete_filter.php"><button class="text-main-light hover:text-main-hover animate-pulse" type="submit" name="submit">Retirer les filtres</button></form><?php } ?>
