            ...
            <form enctype="multipart/form-data" action="/portfolio/allosimplon/build/traitements/modify_film.php" method="post">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="col-start-1 col-span-2">
                        ...
                        <input value="<?=$video?>" type="text" name="video" id="video" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="iframe ytb" required="">
                    </div>
                    <div>
