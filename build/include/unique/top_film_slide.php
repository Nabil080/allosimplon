...
<h1 class="font-bold text-4xl">Les mieux notés</h1>
</div>
...
<?php $request = GetFilm("ORDER BY film_grade DESC ","LIMIT 0,5");// var_dump($film);?>
                        ...
                        <div class="h-full relative group">
                            ...
                            ?>
                                    <div>
                                        ...
                                        <div class="flex justify-start">
                                            <p class="font-normal"><?=substr($film['film_description'],0,200),'...';?></p>
                                        </div>
                                    ...
                                    <!-- IMAGE -->
                                <img src="/portfolio/allosimplon/build/upload/film/<?=$film['film_photo']?>" class="h-[400px] mx-auto">
                            </a>
                        </div>
                    <?php } ?>
                </div>
            ...
            <!-- Item 2 -->
<?php $request = GetFilm("ORDER BY film_grade DESC ","LIMIT 5,10");// var_dump($film);?>
            <div class="hidden duration-3000 ease-in-out h-full" data-carousel-item>
                <div class="absolute block md:gap-2 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 justify-items-center  h-full w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                    <?php while($film=$request->fetch()){ ?>
                        <div class="h-full relative group">
            ...
            <!-- Item 3 -->
<?php $request = GetFilm("ORDER BY film_grade DESC ","LIMIT 10,15");// var_dump($film);?>
            <div class="hidden duration-3000 ease-in-out h-full" data-carousel-item>
                <div class="absolute block md:gap-2 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 justify-items-center  h-full w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                    <?php while($film=$request->fetch()){ ?>
                        <div class="h-full relative group">
            ...
            <!-- Item 4 -->
<?php $request = GetFilm("ORDER BY film_grade DESC ","LIMIT 15,20");// var_dump($film);?>
            <div class="hidden duration-3000 ease-in-out h-full" data-carousel-item>
                <div class="absolute block md:gap-2 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 justify-items-center  h-full w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                    <?php while($film=$request->fetch()){ ?>
                        <div class="h-full relative group">
            ...
            <!-- Item 5 -->
<?php $request = GetFilm("ORDER BY film_grade DESC ","LIMIT 20,25");// var_dump($film);?>
            <div class="hidden duration-3000 ease-in-out h-full" data-carousel-item>
                <div class="absolute block md:gap-2 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 justify-items-center  h-full w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                    <?php while($film=$request->fetch()){ ?>
                        <div class="h-full relative group">
