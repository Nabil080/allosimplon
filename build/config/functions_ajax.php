...
function AddFav(){
    if(require("connexion.php")){
        // RECUP VARIABLES + SAFE
            ...
            if(isset($_POST['ID_film'])){$ID_film=$_POST['ID_film'];            var_dump($ID_film);}
...
function ShowAddFav($ID_film){
    ...
    <button id="<?=$ID_film?>" name="submit" value="submit" class="add-fav group/fav z-20 h-full w-full bg-red-900">
...
$(document).ready(function() {
    ...
    $(".add-fav").click(function(e) {
        ...
        // lorsque l'utilisateur clique sur le bouton "oui"
            $.ajax({
                type: 'POST',
                url: '../traitements/add/add_user_fav.php',
                data: {ID_film: del_id},
