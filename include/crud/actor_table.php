...
<div id="addactor"  tabindex="-1" aria-hidden="true" class=" my-auto hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:max-h-[80%]">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-full">
        ...
        <div class="relative p-4 rounded-lg shadow bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form enctype="multipart/form-data" action="/portfolio/allosimplon/traitements/add/add_actor.php" target="_blank" method="post">
...
<div id="modifyactor<?=$ID?>"  tabindex="-1" aria-hidden="true" class=" my-auto hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:max-h-[80%]">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-full">
        ...
        <div class="relative p-4  rounded-lg shadow bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form enctype="multipart/form-data" action="/portfolio/allosimplon/traitements/modify/modify_actor.php" target="_blank" method="post">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium  text-white">Nom de l'acteur</label>
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative p-4 text-center  rounded-lg shadow bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-center items-center space-x-4">
                ...
                <form action="/portfolio/allosimplon/traitements/delete/delete_actor.php" method="post" >
            ...
            <tr class=" border-b bg-gray-800 border-gray-700  hover:bg-gray-600 h-fit">
                ...
                <th scope="row" class="px-1 py-4 font-medium  whitespace-nowrap text-white max-w-[8rem]">
                    <img src="/portfolio/allosimplon/upload/actor/<?=$photo?>" class="w-full objet-cover" alt="">
                </th>
                <td class="px-6 py-4">
                <?=$name?>
                </td>
