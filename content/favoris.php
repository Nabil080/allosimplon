...
if(empty($_SESSION['filters'])){
  $url = "/portfolio/allosimplon/content/favoris.php?";
}else{
  $url = "/portfolio/allosimplon/content/favoris.php?" . $_SESSION['filters']  . "&";
}
// var_dump($url);
...
<div class="flex justify-center my-4  ">
    <nav aria-label="Page navigation example">
        <ul class="inline-flex items-center -space-x-px">
          ...
          <li>
            <a href="/portfolio/allosimplon/content/catalogue.php?page=<?=$page_count?>" class="block px-3 py-2 leading-tight text-gray-400 hover:text-main-light hover:font-bold ">
...
<?php }} ?>
    <!-- CATALOGUE -->
        <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:-grid-cols-5 [&_img]:w-full [&_img]:h-full object-cover ">
            ...
            <a href="/portfolio/allosimplon/content/film.php?page=<?=$ID?>"   class="cursor-pointer h-full">
            ...
            <div class="absolute bottom-2 text-md p-1 rounded-lg font-bold text-gray-50 w-full mx-auto md:group-hover:hidden"><?php Stars($film['film_grade']);?></div>
              ...
              <div class="hidden lg:block absolute w-full h-full bg-main-dark bg-opacity-80 opacity-0 group-hover:opacity-100 group p-4">
                ...
                <img class="" src="/portfolio/allosimplon/upload/film/<?=$photo?>" alt="<?=$name?>">
                </a>
            </div>
            <?php } ?>
        </div>
...
<?php include('../include/general/footer.php');
  ...
  echo '<a href="/portfolio/allosimplon/index.php" class="text-main-light">Retour à l\'accueil';
}?>
