...
<head>
    ...
    <link rel="stylesheet" href="/portfolio/allosimplon/css/output.css">
    <link rel="stylesheet" href="/Portfolio/allosimplon/css/input.css">
    <link rel="icon" type="image/x-icon" href="/portfolio/allosimplon/img/popcorn.png">
    <script>
        tailwind.config = {
            theme: {
    extend: {
...
<body class="bg-main-dark text-gray-100 bg-cover bg-center bg-fixed bg-no-repeat " style="background-image:url(/portfolio/allosimplon/upload/film/<?=$film['film_background']?>)">
...
<!-- GRILLE -->
    <div class="block md:grid md:grid-cols-2 lg:gap-8  ">
        <div class="p-2 sm:p-4 lg:p-8">
            <img src="/portfolio/allosimplon/upload/film/<?=$film['film_photo']?>" class=" w-full sm:w-[75vw] mx-auto md:w-full" alt="">
        </div>
        <div class="[&>*]:my-4 my-8 relative">
            ...
            <div class="px-8 font-bold text-sm sm:text-base lg:text-xl flex flex-wrap gap-y-4 gap-x-2"><p class="underline ">Genres : </p>
                ...
                while($genres=$request->fetch()){
                    ...
                    while($genre=$genre_info->fetch()){?>
                        <a href="/portfolio/allosimplon/" class="text-main-light hover:text-main-hover font-normal"><?=$genre['genre_name']?></a>
                <?php }
                } ?>
            </div>
            <div class="px-8 font-bold text-sm sm:text-base lg:text-xl flex flex-wrap gap-y-4 gap-x-3"><p class="underline ">Acteurs principaux : </p>
                ...
                while($actors=$request->fetch()){
                    ...
                    <a href="/portfolio/allosimplon/" class="text-main-light relative hover:text-main-hover hover:underline font-normal group">
                        <!-- overlay acteur -->
                        <div class="opacity-0 pointer-events-none group-hover:opacity-100 -translate-y-20 group-hover:-translate-y-0  group-hover:linear duration-500  absolute bottom-10 w-24 aspect-square object-cover ">
                            <img class="w-full h-auto" src="/portfolio/allosimplon/upload/actor/<?=$actor['actor_photo']?>">
                        </div>
        ...
        <?php $request=GetOneRealisator($ID_film);
                while($realisators=$request->fetch()){
                    ...
                    <a href="/portfolio/allosimplon/" class="text-main-light relative hover:text-main-hover hover:underline font-normal group">
                        <!-- overlay réalisateur -->
                        <div class="opacity-0 pointer-events-none group-hover:opacity-100 -translate-y-20 group-hover:-translate-y-0  group-hover:linear duration-500 absolute bottom-10 w-24 aspect-square object-cover">
                            <img class="w-full h-auto" src="/portfolio/allosimplon/upload/realisator/<?=$realisator['realisator_photo']?>">
                        </div>
                ...
                while($scenarists=$request->fetch()){
                    ...
                    <a href="/portfolio/allosimplon/" class="text-main-light relative hover:text-main-hover hover:underline font-normal group">
                        ...
                        <div class="opacity-0 pointer-events-none group-hover:opacity-100 translate-y-20 group-hover:translate-y-0  group-hover:linear duration-500 absolute top-10 w-24 aspect-square object-cover">
                            <img class="w-full h-auto" src="/portfolio/allosimplon/upload/scenarist/<?=$scenarist['scenarist_photo']?>">
                        </div>
...
<div id="modifyfilm<?=$ID_film?>"  tabindex="-1" aria-hidden="true" class=" my-auto hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:max-h-[80%]">
    <div class="relative p-4 w-full max-w-2xl h-full md:h-full">
        ...
        <div class="relative p-4  rounded-lg shadow bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form enctype="multipart/form-data" action="/portfolio/allosimplon/traitements/modify/modify_film.php" target="_blank" method="post">
...
<section class=" bg-transparent py-8 lg:py-16">
  <div class="max-w-2xl mx-auto px-4">
    ...
    <form class="mb-6" method="post" action="/portfolio/allosimplon/traitements/add/add_comment.php">
    ...
    <article class="p-6 text-base mb-6 border-t  border-main-light bg-main-dark">
        <footer class="flex justify-between items-center mb-2">
            ...
            class="hidden z-10 w-fit  rounded divide-y  shadow bg-main-dark divide-gray-600">
                ...
                <ul class="py-1  text-sm  text-gray-200"
                    ...
                    <?php }?>
            <form method="post" action="/portfolio/allosimplon/traitements/manage_comment.php">
        ...
        <form id="new_comment<?=$comment['ID_comment']?>" class="hidden" method="post" action="/portfolio/allosimplon/traitements/manage_comment.php">
            <input class="hidden" name="ID_comment" value="<?=$comment['ID_comment']?>">
        ...
        <div class="relative h-96 w-[80%] mx-auto overflow-hidden rounded-lg  md:h-[400px]">
            ...
            <div class="hidden duration-3000 ease-in-out h-full" data-carousel-item>
                ...
                <?php for($i=0;$i<5;$i++){?>
                            ...
                            <a href="/portfolio/allosimplon/content/film.php?page=<?=$similar_films[$i]['ID_film']?>" class="h-full cursor-pointer overflow-hidden">
                            ...
                            ?>
                                ...
                                <div class="relative w-fit h-96 md:h-[400px] mx-auto">
                                    ...
                                    <img src="/portfolio/allosimplon/upload/film/<?=$similar_films[$i]['film_photo']?>" class="h-full">
                                </div>
                            </a>
                        </div> <?php } ?>
                </div>
